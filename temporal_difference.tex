...
As more and more experience is collected and many small gradient steps are taken according \Cref{eq:TD-learning}, these single-sample estimates will average out to the expectation in \Cref{eq:TD-learning_exp}.
