...
A popular paradigm for distinguishing between model-free and model-based behaviour is the so-called `two-step' task of Daw and colleagues \citep{daw2011model,momennejad2017successor,wang2018prefrontal} (althought note \citealp{akam2015simple}).
