...
\end{equation}
Updating the value function according to \Cref{{eq:TD-learning}} while acting in the environment according to \Cref{{eq:value_action_selection}} leads to an agent that gradually learns to act better and better in the environment as it learns a better value function (\Cref{fig:TD}B-C).
