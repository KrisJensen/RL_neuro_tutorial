...
Modern approaches in (model-free) deep RL can largely be divided into two categories: policy gradient methods and value-based methods.
In policy gradient methods, we directly train the network to output a policy, whereas value-based methods compute a set of state-action values that can be used for action selection.
