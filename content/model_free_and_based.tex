...
\begin{align}
    ...
    %\left [ r(s_{t+1}, a_{t+1}) + \sum_{s_{t+2}} p(s_{t+2} | s_{t+1}, a_{t+1}) \text{argmax}_{a_{t+2}}
    %\left [ r(s_{t+2}, a_{t+2}) + \sum_{s_{t+3}} p(s_{t+3} | s_{t+2}, a_{t+2}) \text{argmax}_{a_{t+3}} Q(s_{t+3}, a_{t+3}) \right ] \right ]
    &= \ldots
\end{align}
}
