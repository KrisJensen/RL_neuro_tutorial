\begin{figure*}[!t]
    ...
    \caption[metaRL]{\label{fig:meta}
        ...
        {\bfseries (B)}~Heatmap showing example behavior of the agent in episodes with different reward probabilities for the first arm, $p(r | a = 1)$.
        ...
        This figure shows the 2-dimensional embedding of neural activity in the meta-RL agent, where we see that the agent converges to different regions of state space for different reward probabilities.
