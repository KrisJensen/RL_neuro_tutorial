\begin{figure*}[!t]
    ...
    \caption[MB]{\label{fig:MB}
        ...
        At episode 40 (vertical black line), the goal was moved from location (9, 0) to location (0, 4), and location (9, 0) was instead given a reward of -1.
        ...
        Reward curves were convolved with a Gaussian kernel ($\sigma = 10$ episodes), which is why performance appears to decrease slightly before episode 40 for the TD agent.
