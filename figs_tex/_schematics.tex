\begin{figure*}[!t]
    ...
    \caption[RL schematics]{\label{fig:schematics}
        ...
        This involves a balance between exploring potentially interesting states (e.g. a new perch) while also exploiting states known to yield high reward (i.e. its current favorite perch).
        ...
        This could for example consist of the chick learning over the course of multiple days when to the trough in anticipation of food.
        ...
        The agent starts in the lower left corner (location [0, 0]) and the episode finished when it encounters either the `cliff' (dark blue) or the goal (yellow; location [9,0]).
        ...
        The arrows indicate the `optimal' policy, which takes the agent to the goal via the shortest possible route while avoiding the cliffs.
        }
    \vspace*{-1.0em}
\end{figure*}
