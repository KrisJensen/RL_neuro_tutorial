\begin{figure*}[!t]
    ...
    \caption[Distributional]{\label{fig:dist}
        ...
        {\bfseries (A)}~Distribution of rewards (black), plotted together with the values converged to across 20 units all learning through standard TD learning (blue), and the expectiles converged to across 20 units learning with distributional RL using different $\tau_i = \frac{\alpha_i^+}{\alpha_i^+ + \alpha_i^-}$ (green).
        ...
        We then impute the distribution implied by these expectiles by assuming it takes the form of a set of $N$ delta functions in the case of $N$ expectiles \citep{rowland2019statistics}.
