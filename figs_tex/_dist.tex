\begin{figure*}[!t]
    ...
    \caption[Distributional]{\label{fig:dist}
        ...
        {\bfseries (C)}~True reward distribution (black) reproduced from (A), now plotted together with the reward distribution $p_{\{ V_i \} }(\tilde{Z})$ implied by the distributional units from (A) and (B) at different stages of learning (light to dark green).
